...
const transformColor = ref(null);
const transformSlide = ref(null);
const transformOpacity = ref(null);
const panelRef = ref(null);
const containerRef = ref(null);
const slideHueRef = ref(null);
const slideOpaRef = ref(null);
const slideGroupRef = ref(null);

provide("slideOpa", slideOpaRef);
provide("panel", panelRef);
provide("container", containerRef);
provide("slideHue", slideHueRef);
provide("slideGroup", slideGroupRef);
...
const handleHueColor = ({ type, value }) => {
	if (type === "set") {
...
const handleOpacityColor = ({ type, value }) => {
	if (type === "set") {
